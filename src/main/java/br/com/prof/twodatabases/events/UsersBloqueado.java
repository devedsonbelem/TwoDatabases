...
public class UsersBloqueado extends UsersEventStatus {
    ...
    public UsersBloqueado() {
	}

	public UsersBloqueado(Integer idUsers, LocalDateTime dataAtivacao, String objectUsers, String status) {
